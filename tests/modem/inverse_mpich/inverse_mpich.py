...
class inverse_mpich:
    test_name = "Inverse Matrix-Free ModEM Test with MPICH"
    test_description = "Test Inverse for a Mod3DMT with MPICH (2 NLCG Itrs)"
    dependencies = None
    ncpus = 7
    ...
    def run(self, env, result, src_dir, test_dir, hpc=None, *args, **kwargs):
        ...
        executables = get_executables(os.path.join(src_dir), 'Mod3DMT')
        ...
        for exe in executables:
            ...
            shutil.copy2(os.path.join(src_dir, exe), os.getcwd())
