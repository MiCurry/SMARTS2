...
class Environment:
    ...
    def parse_file(self, *args, **kwargs):
        ...
        """ Internal validation of Environment.yaml file """

        """ Description section checks """
        if 'Description' not in self.env:
        ...
        """ Determine if lmod modules should be turned on or off for this run. lmod_support will be
        used in the Modset section checks to ensure if a `Module:` keyword can be used or not"""
        ...
        """ HPC Section Checks - None currently"""
